...
class MainActivity : AppCompatActivity() {
    ...
    private fun showBrushSizeChooserDialog(){
        ...
        val smallBtn = brushDialog.findViewById<ImageButton>(R.id.ib_smalll_brush)
        val mediumBtn = brushDialog.findViewById<ImageButton>(R.id.ib_mediumm_brush)
        val largeBtn = brushDialog.findViewById<ImageButton>(R.id.ib_largee_brush)
    ...
    private fun requestStoragePermission(){
           if (ActivityCompat.shouldShowRequestPermissionRationale(this,Manifest.permission.READ_EXTERNAL_STORAGE)){
               showRationaleDialog("Drawing App","Drawing app need to access your external storage")
           }else{
                ...
                try {
                    ...
                    runOnUiThread{
                        ...
                        if (result.isNotEmpty()){
                            ...
                            Toast.makeText(this@MainActivity,"Something wrong while saving the file",Toast.LENGTH_SHORT).show()
                        }
                    }
                }
                catch (e: Exception){
